...
DWH_CONFIG = {
    ...
    'database': 'Projet_Market_DWH',  # <-- Base de données DWH
    'driver': '{ODBC Driver 17 for SQL Server}' 
}

STAGING_CONFIG = {
    'server': r'LAPTOP-VT8FTHG2\DATAENGINEER', 
    'database': 'Projet_Market_Staging', # <-- Base de données Staging
    'driver': '{ODBC Driver 17 for SQL Server}' 
}

def get_dwh_connection():
    """Crée et retourne une connexion à la base de données DWH."""
    conn_str = (
    ...
    # autocommit=False pour gérer les transactions
